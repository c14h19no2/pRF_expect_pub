...
def fit_viol_model(viol_data, pRF_pred, omit_pred, spar_pred):
...
output_dir = os.path.join(
    data_dir, "derivatives", "prf_data", subject, "ses-1", "TRMI-type1-simulation-0"
)
...
TRMI = 0
viol_data = omit_pred + spar_pred + np.random.normal(0, 0.1, omit_pred.shape)
...
(
    ...
    v_p_contrast,
    v_rsq,
) = fit_viol_model(viol_data, pRF_pred, omit_pred, spar_pred)
